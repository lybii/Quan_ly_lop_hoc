...
function TeacherSidebar() {
  ...
  return (
    <div className="flex">
      <button
        className="m-2 p-2 text-gray-700 md:hidden"
      ...
      {/* Sidebar */}
      <div
        className={`fixed left-0 top-0 z-50 flex h-full w-full flex-col items-center rounded-r-2xl bg-white p-4 shadow-2xl transition-transform duration-300 md:static md:w-64 ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}
      >
        {/* Logo Section */}
        ...
        <div className="mt-4 w-full space-y-2">
          <Link to="" onClick={() => setIsOpen(false)}>
            <SidebarItem
              ...
              color="text-blue-700"
              isActive={location.pathname === '/lecturer'}
            />
          </Link>
          ...
          <Link to="classroom" onClick={() => setIsOpen(false)}>
            <SidebarItem
              ...
              color="text-blue-700"
              isActive={location.pathname.startsWith('/lecturer/classroom')}
            />
          </Link>
