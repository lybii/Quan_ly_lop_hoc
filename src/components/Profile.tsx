...
export const Profile: React.FC<ProfileProps> = ({ name, image, role }) => {
  ...
  return (
    <div className="relative mb-10 ml-auto mr-auto mt-4 flex h-[60px] w-[250px] items-center gap-2 rounded-xl bg-white shadow-md">
      ...
      {isDropdownOpen && (
        <div
          className="absolute right-0 top-[70px] w-[250px] rounded-2xl bg-gray-200 shadow-lg duration-300"
          style={{
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
            ...
            <li className="mb-3 mt-3 flex h-[40px] w-full cursor-pointer items-center justify-center rounded-2xl bg-red-500 px-4 py-2 font-bold hover:bg-red-600 hover:duration-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
